...
eGuide = Product.create(
  ...
  sku: "eGuide",
  download_url: "https://teams-stay-green.s3.us-east-2.amazonaws.com/How-to-Make-Microsoft-Teams-Stay-Green.pdf", # Fixed missing closing quote
...
#     <p>Why purchase my eBook? At the age of 26, I closed on my first house. While this might not be a surprise to the majority, homeownership while in your mid-20's as a minority is exceptionally rare.</p> 
#     <p>My goal is to help you and others young adults prepare to excel in the adulting game.</p>
